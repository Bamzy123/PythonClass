...
class TestGeoPoliticalZone(unittest.TestCase):
    def test_north_central_states(self):
        ...
        self.assertEqual(GeoPolitical.get_political_zone("Fct"), "North Central")

    def test_north_east_states(self):
        self.assertEqual(GeoPolitical.get_political_zone("Bauchi"),"North East")
    ...
    def test_south_east_states(self):
        self.assertEqual(GeoPolitical.get_political_zone("Anambra"),"South East")
    ...
    def test_unrecognized_state(self):
        self.assertIsNone(GeoPolitical.get_political_zone("InvalidState"))
